...
setlocal
cd /d "%~dp0"
title MARU OBS Helper V0.22.99 - ONE TOUCH USB LIVE

echo ============================================================
echo   MARU OBS Helper V0.22.99 - ONE TOUCH USB LIVE
...
echo Starting MARU Helper V0.22.99...
echo.
...
echo.
echo ============================================================
echo   MARU Helper V0.22.99 stopped. Exit code: %RC%
