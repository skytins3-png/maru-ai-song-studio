...
renderWordChoices();renderRegions();renderInstruments();autoPick();renderSaved();updateScoreMode();if('serviceWorker'in navigator)navigator.serviceWorker.register('sw.js?v=0.6.0');
