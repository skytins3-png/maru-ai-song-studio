const CACHE='maru-music-v0.22.40-clean';
const FILES=['./','index.html','styles.css?v=0.22.40','score.css?v=0.22.40','vendor/vexflow.js?v=5.0.0','vendor/sfumato.js?v=0.22.40','samples/GENERALUSER-LICENSE.txt','vendor/SOUNDFONT2-ESM-LICENSE.txt','vendor/SFUMATO-LICENSE.txt','app.js?v=0.22.40','manifest.webmanifest','icons/icon.svg','icons/icon-192.png','icons/icon-512.png'];
