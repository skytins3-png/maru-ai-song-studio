const CACHE='maru-music-v0.22.17-clean';
const FILES=['./','index.html','styles.css?v=0.22.17','score.css?v=0.22.17','vendor/vexflow.js?v=5.0.0','vendor/sfumato.js?v=0.22.17','samples/GENERALUSER-LICENSE.txt','vendor/SOUNDFONT2-ESM-LICENSE.txt','vendor/SFUMATO-LICENSE.txt','app.js?v=0.22.17','manifest.webmanifest','icons/icon.svg'];
