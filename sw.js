const CACHE='maru-music-v0.23.04-stable-keeper';
const FILES=['./','index.html','styles.css?v=0.23.04','score.css?v=0.22.89','vendor/vexflow.js?v=5.0.0','vendor/sfumato.js?v=0.22.89','samples/GENERALUSER-LICENSE.txt','vendor/SOUNDFONT2-ESM-LICENSE.txt','vendor/SFUMATO-LICENSE.txt','app.js?v=0.23.04','manifest.webmanifest','icons/icon.svg','icons/icon-192.png','icons/icon-512.png'];
